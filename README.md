...
Calculations:
1. Flight Time Computation & Analysis Converts scheduled and actual departure times to UTC.
...
3. Parallel Processing for Performance Uses ThreadPoolExecutor and ProcessPoolExecutor to speed up computations.

Efficiently processes large datasets in parallel for faster insights.

4. Interactive Dashboard (Streamlit) View real-time visualizations of flight statistics and weather impacts.
